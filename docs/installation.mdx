...
updated ones from the [downloads page](https://essentialsx.net/downloads.html). No other file should be changed.

:::note Updating Modules, Configuration and Server Versions Note
